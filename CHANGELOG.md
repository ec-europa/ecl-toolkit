...
- `builder`, `eslint-config`, `qa`, `stylelint-config`
  - [#66](https://github.com/ec-europa/ecl-toolkit/pull/66) chore(deps): update dependencies - no issue ([@yhuard](https://github.com/yhuard))
...
- `ecl-builder`, `ecl-fractal-theme`, `ecl-qa`, `eslint-config-ecl`, `stylelint-config-ecl`
  - [#58](https://github.com/ec-europa/ecl-toolkit/pull/58) feat(theme): improve responsive behaviour - INNO-867. ([@yhuard](https://github.com/yhuard))
...
- `ecl-builder`, `ecl-components-preset-base`, `ecl-fractal-theme`, `stylelint-config-ecl`
  - [#46](https://github.com/ec-europa/ecl-toolkit/pull/46) chore(package): update dependencies - no issue. ([@yhuard](https://github.com/yhuard))
...
- `ecl-builder`, `ecl-components-preset-base`, `ecl-fractal-theme`, `ecl-qa`, `stylelint-config-ecl`
  - [#41](https://github.com/ec-europa/ecl-toolkit/pull/41) chore(deps): update dependencies. ([@yhuard](https://github.com/yhuard))
